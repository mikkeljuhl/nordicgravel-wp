...
function minalite_customize_register( $wp_customize ) {
	...
	$wp_customize->add_control(
            new minalite_Customize_Pro_Control(
                ...
                array(
                    ...
                    'description'   => sprintf( __('<span>Featured slider (<a target="_blank" href="https://zthemes.net/mina/">Demo</a>)</span><span>6 Different Blog Layouts</span><span>Fully Responsive</span><span>100+ Customizable coloring options</span><span>4 Custom Widgets</span><span>Posts/Page Settings</span><span>Footer Copyright Text</span><span>Lifetime Upgrades</span><span>LifeTime Support</span><span>Mailchimp Support</span><span>Well Documented</span><span>Child Theme included</span><span>And More...</span>','minalite')),
                    'section'    => 'mina_pro',
                )
            )
	);
    ...
    // More Free Themes
    $wp_customize->add_section( 'mina_more_free' ,
        array(
            'title'       => esc_html__( 'More Free Themes', 'minalite' ),
            'description' => '',
            'panel'       => 'theme_options',
            'piority'     => 6
        )
    );
    $wp_customize->add_setting( 'mina_free_mores', array(
            'sanitize_callback' => 'sanitize_text_field',
        ) );
    $wp_customize->add_control(
            new minalite_Customize_Pro_Control(
                ...
                'mina_free_mores',
                array(
                    'label'      => esc_html__( 'More Free Themes from ZThemes', 'minalite' ),
                    'description'   => sprintf( __('<span>Odier Lite</span><span>Black Lite</span><span>Kokoro Lite</span><span>Mina Lite</span><span>And More...</span>','minalite')),
                    'section'    => 'mina_more_free',
                )
            )
    );
    $wp_customize->add_setting( 'mina_more_free_links', array(
            'sanitize_callback' => 'sanitize_text_field',
    ) );
    $wp_customize->add_control(
        new minalite_Customize_Pro_Control(
            $wp_customize,
            'mina_more_free_links',
            array(
                'description'   => sprintf( __('<a target="_blank" class="minalite-morefree-button" href="https://zthemes.net/themes/category/wordpress/free">Download Free</a>', 'minalite')),
                'section'    => 'mina_more_free',
            )
        )
    );
